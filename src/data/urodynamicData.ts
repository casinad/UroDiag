...
const TOOLTIPS: { [key: string]: string } = {
  ...
  "En cas de BCI limite, envisager une hypocontractilité relative si traitement alpha-bloquant inefficace": "Un BCI (Bladder Contractility Index) entre 100 et 150 indique une contractilité vésicale “limite”. Si les symptômes persistent malgré un traitement alpha-bloquant, une hypocontractilité relative du détrusor peut être en cause.",
