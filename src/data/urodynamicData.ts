...
const TOOLTIPS: { [key: string]: string } = {
  ...
  "En cas de BCI limite, envisager une hypocontractilité relative si traitement alpha-bloquant inefficace": "Le BCI évalue la force de contraction vésicale (Pdet + 5 × Qmax).\n\n• BCI > 150 : contractilité normale ou forte\n• 100 < BCI < 150 : contractilité limite\n• BCI < 100 : hypocontractilité probable\n\nChez les patients avec obstruction modérée et BCI “limite”, un échec au traitement alpha-bloquant peut révéler une défaillance du détrusor sous-jacente.",
